...
public class MemberAdapter extends ArrayAdapter<Member> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String details = ParseUtils.role(getContext(), member.getRole()) + "; " + getContext().getResources().getString(R.string.joined_at) + ParseUtils.timeSeconds(member.getJoinedAt());
